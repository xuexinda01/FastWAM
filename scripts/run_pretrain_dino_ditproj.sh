...
# (DiT-side projection — no MLP bottleneck, DINO 1024d → DiT patchify directly)
# =============================================================================
#
# Prerequisites:
...
# Usage:
#   # Single GPU
#   bash scripts/run_pretrain_dino_ditproj.sh
#
#   # Multi-GPU (e.g., 8 GPUs)
#   NUM_GPUS=8 bash scripts/run_pretrain_dino_ditproj.sh
...
DEEPSPEED_FILE="/tmp/ds_config_pretrain_dino_ditproj_$$.json"
