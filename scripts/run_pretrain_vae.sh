#!/bin/bash
# =============================================================================
# Wan2.2 Continue-Pretrain with VAE encoder on OpenVid-1M
# =============================================================================
#
# Prerequisites:
...
# Usage:
#   # Single GPU
#   bash scripts/run_pretrain_vae.sh
#
#   # Multi-GPU (e.g., 8 GPUs)
#   NUM_GPUS=8 bash scripts/run_pretrain_vae.sh
...
DEEPSPEED_FILE="/tmp/ds_config_pretrain_vae_$$.json"
